...
?>
<div id="accountHistInfo" class="centerColumn">
    ...
    <div class="content shipping-outer">
		<div class="panel panel-default head-wrap">
			<div class="panel-heading">
				<h4 class="panel-title"><?php echo sprintf(HEADING_ORDER_NUMBER, $HTTP_GET_VARS['order_id']); ?></h4>
			</div>
		</div>
    ...
    <div class="content shipping-outer">
		<div class="panel panel-default head-wrap">
			<div class="panel-heading">
				<h4 class="panel-title"><?php echo HEADING_ORDER_HISTORY; ?></h4>
			</div>
		</div>
        <div class="contentText">
            <table border="0" width="100%" cellspacing="1" cellpadding="2">
                <tr>
                    ...
                    <?php
                      $statuses_query = tep_db_query("select os.orders_status_name, osh.date_added, osh.comments from " . TABLE_ORDERS_STATUS . " os, " . 
    ...
    <?php } else { }?>
    <div class="buttonSet">
    	<span class="cart-buttons ckpc ck-btn">
			<?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w', tep_href_link('account_history.php', 
