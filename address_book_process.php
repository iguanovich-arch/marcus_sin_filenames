...
<div class="content shipping-outer">
  <div class="panel panel-default head-wrap">
	<div class="panel-heading">
		<h4 class="panel-title"><?php echo DELETE_ADDRESS_TITLE; ?></h4>
	</div>
  </div>
...
<div class="cart-buttons ck-btn">
 <span class="cart-buttons bkbc"><?php echo tep_draw_button(IMAGE_BUTTON_DELETE, 'trash', tep_href_link('address_book_process.php', 'delete=' . $HTTP_GET_VARS['delete'] . '&action=deleteconfirm&formid=' . md5($sessiontoken), 'SSL'), 'primary'); ?></span>

     <span class="cart-buttons"><?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w', tep_href_link('address_book.php', '', 'SSL')); ?></span>
</div>
</div>
<?php
  } else {
...
<?php echo tep_draw_form('addressbook', tep_href_link('address_book_process.php', (isset($HTTP_GET_VARS['edit']) ? 'edit=' . $HTTP_GET_VARS['edit'] : ''), 'SSL'), 'post', 'onsubmit="return check_form(addressbook);"', true); ?>

<div class="contentContainer shipping-outer">
...
?>
  ...
  <div class="cart-buttons ck-btn">
    <span class="cart-buttons bkbc"><?php echo tep_draw_hidden_field('action', 'update') . tep_draw_hidden_field('edit', $HTTP_GET_VARS['edit']) . tep_draw_button(IMAGE_BUTTON_UPDATE, 'refresh', null, 'primary'); ?></span>
...
?>
  ...
  <div class="buttonSet cart-buttons ck-btn">
    <span class="cart-buttons bkbc"><?php echo tep_draw_hidden_field('action', 'process') . tep_draw_button(IMAGE_BUTTON_CONTINUE, 'triangle-1-e', null, 'primary'); ?></span>

    <span class="cart-buttons"><?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w', $back_link); ?></span>
  </div>
