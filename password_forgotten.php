...
<div class="content shipping-outer nopad">
	...
	<br class="clearBoth">
    <div class="lable"><?php echo ENTRY_EMAIL_ADDRESS; ?></div>
	...
	<div class="cart-buttons ck-btn">
		...
		<span class="cart-buttons"><?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w', tep_href_link('login.php', '', 'SSL')); ?></span>
	</div>
</div>
</div>
</div>
