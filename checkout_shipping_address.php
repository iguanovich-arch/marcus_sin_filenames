...
<div id="checkoutShipAddressDefault" class="centerColumn">
...
?>
	<div class="content shipping-outer">
		<div class="panel panel-default head-wrap">
			<div class="panel-heading">
				<h4 class="panel-title"><?php echo TABLE_HEADING_SHIPPING_ADDRESS; ?></h4>
			</div>
		</div>
...
?>
	<div class="content shipping-outer">
		<div class="panel panel-default head-wrap">
			<div class="panel-heading">
				<h4 class="panel-title"><?php echo TABLE_HEADING_ADDRESS_BOOK_ENTRIES; ?></h4>
			</div>
		</div>
...
?>
      ...
      <tr>
        <td colspan="2"><?php echo tep_address_format($format_id, $addresses, true, ' ', ', '); ?></td>
      </tr>
...
?>
   	<div id="checkoutNewAddress" class="centerColumnModule">
        	<div class="content shipping-outer">
				<div class="panel panel-default head-wrap">
					<div class="panel-heading">
						<h4 class="panel-title"><?php echo TABLE_HEADING_NEW_SHIPPING_ADDRESS; ?></h4>
					</div>
				</div>
                <div class="alert-text forward">
 	...
 	<div class="cart-buttons ckpc bkbc ck-btn">      	
...
?>
  ...
  <div class="cart-buttons ckpc ck-btn">
