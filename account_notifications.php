...
?>
<div id="accountNotifications" class="centerColumn">
    ...
    <div class="content shipping-outer">
		<div class="panel panel-default head-wrap">
			<div class="panel-heading">
				<h4 class="panel-title"><?php echo MY_NOTIFICATIONS_TITLE; ?></h4>
			</div>
		</div>
    ...
    <div class="content shipping-outer">
		<div class="panel panel-default head-wrap">
			<div class="panel-heading">
				<h4 class="panel-title"><?php echo GLOBAL_NOTIFICATIONS_TITLE; ?></h4>
			</div>
		</div>
        <div class="contentText">
    ...
    <?php if ($global['global_product_notifications'] != '1') { ?>
    <div class="content shipping-outer">
		<div class="panel panel-default head-wrap">
			<div class="panel-heading">
				<h4 class="panel-title"><?php echo NOTIFICATIONS_TITLE; ?></h4>
			</div>
		</div>
        <div class="contentText">
        <?php
