...
<?php echo tep_draw_form('email_friend', tep_href_link('tell_a_friend.php', 'action=process&products_id=' . (int)$HTTP_GET_VARS['products_id']), 'post', '', true); ?>

<div class="contentContainer">
  <div>
    <span class="inputRequirement" style="float: right;"><?php echo FORM_REQUIRED_INFORMATION; ?></span>
    <header><h2><?php echo FORM_TITLE_CUSTOMER_DETAILS; ?></h2></header>
  </div>
  ...
  <header><h2><?php echo FORM_TITLE_FRIEND_DETAILS; ?></h2></header>
  ...
  <header><h2><?php echo FORM_TITLE_FRIEND_MESSAGE; ?></h2></header>
  ...
  <div class="buttonSet">
    ...
    <?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w', tep_href_link('product_info.php', 'products_id=' . (int)$HTTP_GET_VARS['products_id'])); ?>
  </div>
</div>
