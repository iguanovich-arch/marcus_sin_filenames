...
<?php echo tep_draw_form('checkout_address', tep_href_link('checkout_shipping.php', '', 'SSL'), 'post', '', true) . tep_draw_hidden_field('action', 'process'); ?>
    ...
    <div class="panel panel-default head-wrap">
		<div class="panel-heading"><h4 class="panel-title step-checkout"><?php echo CHECKOUT_BAR_DELIVERY_1; ?></h4></div>
	</div>
    <div>
    ...
    <div class="content shipping-outer">
		<div class="panel panel-default head-wrap">
			<div class="panel-heading">
				<h4 class="panel-title"><?php echo TITLE_SHIPPING_ADDRESS; ?></h4>
			</div>
		</div>
        <div class="row checkout-payment-content">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 billing-address">
                <address class="sendto-address mt">
                	<?php echo tep_address_label($customer_id, $sendto, true, ' ', '<br />'); ?>
            	</address>
                <span class="cart-buttons"><?php echo tep_draw_button(IMAGE_BUTTON_CHANGE_ADDRESS, 'home', 
                    tep_href_link('checkout_shipping_address.php', '', 'SSL')); ?>
                </span>
            </div>
...
?>
	<div class="content shipping-outer">
		<div class="panel panel-default head-wrap">
			<div class="panel-heading">
				<h4 class="panel-title"><?php echo TABLE_HEADING_SHIPPING_METHOD; ?></h4>
			</div>
		</div>
...
?>
  	...
  	<div class="content shipping-outer">
  		<div class="contentText" id="checkout_comments">
			<div class="panel panel-default head-wrap">
				<div class="panel-heading">
					<h4 class="panel-title"><?php echo TABLE_HEADING_COMMENTS; ?></h4>
				</div>
			</div>
	...
	<div class="cart-buttons ck-btn">
		...
		<div class="chk-ship"><?php echo "Continue to Step 2 - choose your shipping method.";?></div>
  	</div>
</div>
<script type="text/javascript">
