...
?>
	<div class="panel panel-default head-wrap">
		<div class="panel-heading">
			<h4 class="panel-title"><?php echo CHECKOUT_BAR_PAYMENT_1; ?></h4>
		</div>
	</div>
    <div>
	...
	<div class="content shipping-outer">
		<div class="panel panel-default head-wrap">
			<div class="panel-heading">
				<h4 class="panel-title"><?php echo TABLE_HEADING_BILLING_ADDRESS; ?></h4>
			</div>
		</div>
 ...
 <div class="content shipping-outer">
	<div class="panel panel-default head-wrap">
		<div class="panel-heading">
			<h4 class="panel-title"><?php echo TABLE_HEADING_PAYMENT_METHOD; ?></h4>
		</div>
	</div>
